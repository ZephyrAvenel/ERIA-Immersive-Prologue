...
export interface LocaleMessages {
  ...
  readonly workshopEntrySteps: string;
  readonly workshopEntryStart: string;
  readonly workshopEntryResume: string;
  readonly workshopEntryReview: string;
  readonly workshopEntryRestart: string;
  readonly workshopEntryResumeProgress: string;
  readonly workshopEntryCompletedProgress: string;
  readonly workshopEntryIntro: string;
  readonly workshopEntryPrivacy: string;
  readonly workshopEntryBack: string;
  readonly workshopEntryRestartTitle: string;
  readonly workshopEntryRestartDescription: string;
  readonly workshopEntryRestartCancel: string;
  readonly workshopEntryRestartConfirm: string;
  ...
  readonly workshopPromptCopyAction: string;
